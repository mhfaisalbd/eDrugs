...
namespace eDrugs.Controllers
{
    public class DrugsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,BatchNo,GenericName,BusinessName")] Drug drug)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,BatchNo,GenericName,BusinessName")] Drug drug)
        {
            if (id != drug.Id)
            {
                return NotFound();
